...
export const MODULE_ACTIONS = {
  ...
  // (not an override-able has_permission() branch, see
  // supabase/migrations/20260801150000_supply_records.sql) — only view
  // is actually configurable, same shape as reports.
  supply_records: ["view"],
