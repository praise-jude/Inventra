...
import { resolveAdminTeamContext, resendInviteForContext } from "@/lib/team-service";
import { authenticateMobileRequest, mobileErrorResponse } from "@/lib/mobile-auth";
import { logAudit } from "@/lib/actions/audit";

// Mobile equivalent of resendInvite (lib/actions/team.ts).
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    await resendInviteForContext(auth.supabase, context, memberId);
    ...
    return mobileErrorResponse(err, "Could not resend the invite email.");
  }
}
